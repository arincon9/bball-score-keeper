			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col-md-3 text-center'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('close justify-content-center'),
										_1: {
											ctor: '::',
...
var _user$project$Main$playSection = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('row justify-content-md-center'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('row mb-5'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('form-control col'),
											_1: {
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'id', 'inputDefault'),
												_1: {ctor: '[]'}
											}
										}
									}
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('btn btn-outline-danger'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_('button'),
										_1: {
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fa fa-pencil-square-o fa-2x justify-content-center'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-hidden', 'true'),
										_1: {
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('btn btn-outline-success mx-2'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('btn btn-outline-info mx-2'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container mt-5'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('row justify-content-md-center mb-5'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
